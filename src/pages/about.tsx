...
function WritingSocialLink({ className, href, children, icon: Icon }: SocialLinkProps) {
  return (
...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Paul Morris</title>
        <meta name="description" content="I’m Paul Morris. I live in New York City, where I design the future." />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Paul Morris. I live in New York City, where I design the future.
            </h1>
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <WritingSocialLink href="#" icon={IconBrandGithub} className="mt-4">
                Follow on GitHub
              </WritingSocialLink>
              <WritingSocialLink href="#" icon={IconBrandLinkedin} className="mt-4">
                Follow on LinkedIn
              </WritingSocialLink>
              <WritingSocialLink
